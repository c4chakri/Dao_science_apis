...
contract ${contractName} is ERC20, Ownable, Pausable, ReentrancyGuard {
    ...
    struct Stake {
        ...
        bool isRewarded; // Track if reward has been claimed
    }

    mapping(address => Stake[]) public userStakes; // Maps each user to their array of stakes
    mapping(address => uint256) public totalStaked; // Tracks total staked per user
